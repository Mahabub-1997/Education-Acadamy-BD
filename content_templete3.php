...
<div class="container">
    <div class="content">
        <img src="img/8.jpg" alt="lights" >
        <div class="wrapper">
            <h1>Spin-Based Quantum Computing Breakthrough</h1>
            <p>- Henric</p>
            <section class="block">
                <p>Physicists from MIPT and the Russian Quantum Center, joined by colleagues from Saratov State University and Michigan Technological University, have demonstrated new methods for controlling spin waves in nanostructured bismuth iron garnet films via short laser pulses. Presented in Nano Letters, the solution has potential for applications in energy-efficient information transfer and spin-based quantum computing.
...
To excite magnetization precession, the team used linearly polarized pump laser pulses, whose characteristics affected spin dynamics and the type of spin waves generated. Importantly, wave excitation resulted from optomagnetic rather than thermal effects.</p>
                <p>The researchers relied on 250-femtosecond probe pulses to track the state of the sample and extract spin wave characteristics. A probe pulse can be directed to any point on the sample with a desired delay relative to the pump pulse. This yields information about the magnetization dynamics in a given point, which can be processed to determine the spin wave’s spectral frequency, type, and other parameters.
...
Reference: “All-Dielectric Nanophotonics Enables Tunable Excitation of the Exchange Spin Waves” by Alexander I. Chernov*, Mikhail A. Kozhaev, Daria O. Ignatyeva, Evgeniy N. Beginin, Alexandr V. Sadovnikov, Andrey A. Voronov, Dolendra Karki, Miguel Levy and Vladimir I. Belotelov, 9 June 2020, Nano Letters.</p>
